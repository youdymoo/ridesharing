...
./h3-bin/h3ToGeo < ./data/index/tripData-index.txt >./data/index/tripData-center.txt
./h3-bin/h3ToGeo < ./data/index/tripData-index-complete.txt >./data/index/tripData-center-complete.txt
